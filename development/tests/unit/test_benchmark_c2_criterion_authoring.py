"""Checks for object-aliasing criterion probes before the full manifest exists."""
...
def test_c2_criterion_probes_are_structurally_distinct_and_tested() -> None:
    plan = load_design(DESIGN_PATH)
    cases = tuple(case for case in plan.held_out_cases if case.concept_id == "object-aliasing")
