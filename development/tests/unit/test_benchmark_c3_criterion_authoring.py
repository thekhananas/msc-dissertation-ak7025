"""Checks for function-argument criterion probes before the full manifest exists."""
...
def test_c3_criterion_probes_are_structurally_distinct_and_tested() -> None:
    plan = load_design(DESIGN_PATH)
    cases = tuple(case for case in plan.held_out_cases if case.concept_id == "function-arguments")
