"""Command interface for publishing the acquisition-study development budget curve."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Publish the paired development acquisition budget curve"
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        run_id = args.run_id or f"acquisition-development-budget-curve-{short_revision}"
        ...
        print(
            json.dumps(
                {
                    "command": "publish-development-budget-curve",
